    ...
    def display_meal_choices(self,person,recommendations):    
        ...
        if len(recommendations)==3:
            ...
            with breakfast_column:
                if recommendations[0] is not None:
            ...
            with launch_column:
                if recommendations[1] is not None:
                    ...
                    launch_choice = None
            with dinner_column:
                if recommendations[2] is not None:
            ...
            with morning_snack:
                if recommendations[1] is not None:
                    ...
                    st.write("No morning snack recommendations available")
                    morning_snack = None
            with launch_column:
                if recommendations[2] is not None:
                    ...
                    launch_choice = None
            with dinner_column:
                if recommendations[3] is not None:
            ...
            with afternoon_snack:
                if recommendations[3] is not None:
                    ...
                    st.write("No afternoon snack recommendations available")
                    afternoon_snack = None
            with dinner_column:
                if recommendations[4] is not None:
